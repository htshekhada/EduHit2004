...
public class Deleteshoq1 extends HttpServlet
{
...
*/
     ...
     try  {
                 ...
                 rs = stmt.executeQuery("SELECT * FROM "+stdsub+" where queno >= "+ccm+" and queno <= "+ccm+"+4 and quefield='sho' and chap="+lno+" order by queno , wrong1");
              // rs = stmt.executeQuery("SELECT * FROM "+s2+s1+" where queno >= "+ccm+" and queno <= "+ccm+"+1 and quefield='sho' order by queno , wrong1");   
                                                 ...
                                                 if(name.equals(""+qno+"d"))
                                                        {
                                                          ...
                                                          stmt1.executeUpdate("delete * from "+stdsub+" where queno = "+qno+" and quefield='sho' and chap="+lno+";");
