...
public class Rev3 extends HttpServlet
{
...
//     out.println("<body bgcolor=\"rgb(241,232,254)\">");
...
//             String envf[] =gEnv.getAvailableFontFamilyNames();
       ...
       out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Rev3s\" target=\"topmiddle\">");
