          ...
          if(bcheck1.equals("yes") || joi!=tot1)
            {
                                        ...
                                        out.println("<font face=\"Times New Roman\" color=\"green\"> "+exmmsg+"</font>");
                                        out.println("</font>");  
                                        out.println("</th>");
                                        if(flag1==1)
                                        {
               ...
               hitesh:            while(rs.next())
                 ...
                 for(h1=1;h1<=maxjoi;h1++)
                  ...
                  out.println("<center><input  type=\"submit\" value=\"Try It\" name=\"next\" style=\"font-family: Times New Roman; font-size: 18pt\"></center>");
                 }
                    if(joi==tot1)
                      {
                      out.println("<br><br><br><br><center><font face=\"Times New Roman\" size=5 color=\"blue\">The Revision of Question-4 of chapter:"+lno+" has been Complete!</font></center>");
                      }
           }//end of try
      catch (Exception e) {
