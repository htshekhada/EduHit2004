...
public class Longques extends HttpServlet
{
...
////**********************Inserting into subject table**********
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Longquec\" target=\"topright\">");

     out.println("<center><strong><center><font face=\"Times New Roman\" size=\"4\">Que-3</font></center></strong></center>");
