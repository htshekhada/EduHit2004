...
hitesh4:
         ...
         stmt.executeUpdate("update biodata set endtime="+h2+" where rollno="+ r1+ " and std="+s1+" and class='"+c1+"' and subject='"+sub+"' " );
                                    ...
                                    out.println("<strong><font face=\"Times New Roman\" size=\"7\" color=\"blue\">Roll Number & Name Is Must. Roll Number Must Be In Number.</font></strong>");
                                    rolval=1;
                               //       out.println("<pre>");
...
if(noss==0 && rolval==0)
      {expcnt=expcnt+1;
       out.println("<table border=\"8\" width=\"515\">");
       out.println("<tr><th><font face=\"Times New Roman\" size=\"7\" color=\"blue\">Your Time Starts Now...</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face=\"Arial\" size=\"5\">   "+h1+":"+m1+":"+sec1+"</font></th></tr>");
       out.println("<tr><th><font face=\"Times New Roman\" size=\"7\" color=\"red\">Click On The Following Button</font></th></tr>");
       out.println("</table>");
       out.println("</center>");
       ...
       out.println("<center>");
       out.println("<p><input  type=\"submit\" value=\"Best Of Luck\" name=\"start\" style=\"font-family: Times New Roman; font-size: 18pt\"></p>");
       out.println("</center>");
    ...
    if(rolval==0)
       {
       out.println("<table border=\"8\" width=\"515\">");
       out.println("<tr><th><font face=\"Times New Roman\" size=\"6\" color=\"blue\">Select Appropriat Standard With Subject & Class</font></th></tr>");
       out.println("<tr><th><font face=\"Times New Roman\" size=\"5\" color=\"red\">Click On The Following Button To Go Back</font></th></tr>");
       out.println("</table>");
       out.println("</center>");
       out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/form\">");
       out.println("<center>");
       out.println("<p><input  type=\"submit\" value=\"Go Back\" name=\"start\" style=\"font-family: Times New Roman; font-size: 18pt\"></p>");
       out.println("</center>");
       }
      }
