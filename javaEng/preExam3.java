...
//    out.println("<b><font face=\"Arial\">");
    out.println("<br><br><br><br><center><font face=\"Times New Roman\" size=\"7\" color=\"blue\" >Exam Of Question-4 Complete.</font></center>");
...
if(state==0 && state1==0){                     
           ...
           //      fon=rs.getString("fn");
              //   out.println("<font face=\""+fon+"\" size=\"20\">");
                   String  exmmsg="Join The Matches";
            ...
            //    out.println("<font face = \" "+fon+" \" color=\"#0000FF\"size=\"5\">")  ;
                out.println("<center><font face=\"Arial\" SIZE=4></font><font face=\"Times New Roman\" size=\"5\" color=\"blue\"> "+exmmsg+"</font></center>");
                //("+number1+")
                out.println("</font>");  
                out.println("</td>");
                ...
                label1:               while(ele <= maxjoi)
                 ...
                 //    fon=rs.getString("fn");
                     ...
                     rs.next(); 
                                 ...
                                 out.println("<p align=\"center\"><input  type=\"submit\" value=\"Next Question\" name=\"next\" style=\"font-family: Times New Roman; font-size: 18pt\"></p>");
                                 out.println("</form>");
                                 } 
           }
      catch (Exception e) {
