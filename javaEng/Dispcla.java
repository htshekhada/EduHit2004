...
public class Dispcla extends HttpServlet
{
...
//      out.println("<body background=\"c:/EduHit/bg3.jpg\">");
      ...
      String std2=null,c2=null,msub=null;
      std1=request.getParameter("std");
      c1=request.getParameter("class");
      msub=request.getParameter("subject");
  ...
  rs2=stmt2.executeQuery("select distinct rollno from genresult where  std="+std1+" and class='"+c1+"' and subject='"+msub+"' order by rollno");
  while(rs2.next())
    {
       r1   = rs2.getString("rollno");
        ...
        out.println("  <tr> ");
        out.println("<th bgcolor=\"rgb(211,255,213)\"><strong><font face=\"Times New Roman\" size=4><span style=\"text-transform: capitalize\"><p align=\"center\">Progress Report Of Subject "+msub+"</span></font></strong></th>");
        out.println(" </tr>");
        ...
        rs=stmt.executeQuery("select * from genresult where rollno="+r1+" and std="+std1+" and class='"+c1+"' and subject='"+msub+"' order by month1,date1");
