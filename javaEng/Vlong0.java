...
public class Vlong0 extends HttpServlet
{
...
////**********************Inserting into subject table**********
     ...
     out.println("<center>");
     out.println("<strong><font face=\"Times New Roman\" size=\"4\">Question Type   </font></strong>");
     out.println("<strong>");

//     out.println("<font face=\""+fon2+"\" size=\"5\">");
     out.println("<input type=\"text\" name=\"Qtype\" size=\"30\" maxlength=\"100\"   style=\"font-family:"+fon2+"\">&nbsp;</strong>");


     out.println("<font face=\"Times New Roman\"><strong>Right</strong></font>");

     out.println("<select  name=\"rightno\" size=\"1\" >");
     ...
     out.println("<font face=\"Times New Roman\"><strong>Wrong</strong></font>");

     out.println("<select  name=\"wrongno\" size=\"1\" >");
     ...
     out.println("<input  type=\"radio\" value=\"esh\" name=\"hts\"><strong>Tag</strong>");
