...
import java.util.*;
public class Deletestdo extends HttpServlet
{
...
*/      
      ...
      out.println("<form method=\"get\" action=\"http://"+request.getServerName()+":8080/servlet/Deletesubo\" target=\"middleleft\">");
      ...
      ResultSet rs=null;
              ...
              out.println("<center><strong><font face=\"Times New Roman\" size=\"4\" color=red>Deletion Of Questions From Que-1.</font></strong></center>");
              out.println("<br>");
