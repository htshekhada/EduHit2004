...
//      String s2=e1.replace('!',' ');
        ...
        out.println("  <tr> ");
        out.println("<th bgcolor=\"rgb(211,255,213)\"><strong><font face=\"Times New Roman\" size=4><span style=\"text-transform: capitalize\"><p align=\"center\">"+s2+"</span></font></strong></th>");
        out.println(" </tr>");
     ...
     //           out.println("<tr>");
     //           out.println("<td><p align=\"left\"><font face=\"Arial\" size=2><strong>"+result+"</strong></font></td>");
    //            out.println("<td><p align=\"left\"><font face=\"Arial\" size=2><strong>"+got+"%</strong></font></td>");
