...
import java.util.*;
public class Updatestdl extends HttpServlet
{
...
*/      
      ...
      out.println("<body bgcolor=\"rgb(133,213,135)\">");
              ...
              out.println("<center><strong><font face=\"Times New Roman\" size=\"4\">Updation Module Of Questions For Que-3.</font></strong></center>");
              out.println("<br>");


      out.println("<form method=\"get\" action=\"http://"+request.getServerName()+":8080/servlet/Updatesubl\" target=\"middleleft\">");
