...
public class Echnames extends HttpServlet
{
 public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
  ...
  //    out.println("<br><br><br><br>");
      out.println("<center>");
      out.println("<strong><font face=\"Times New Roman\" size=4>Chapter Name Entry</font></strong>");
      out.println("</center>");
//      out.println("<br>");
    //********************** <option value=\"computer\">computer</option>
      ...
      try  {
                 ...
                 out.println("&nbsp;&nbsp;&nbsp;<center><strong><font face=\"Times New Roman\" size=4>Subject</font></strong>&nbsp;<select  name=\"subject\" size=\"1\" style=\"font-size:15pt\">");
