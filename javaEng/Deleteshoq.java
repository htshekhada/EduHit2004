...
public class Deleteshoq extends HttpServlet
{
...
*/      
      ...
      String stdsub=null,q1=null,fname=null;
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Deleteshoq1\">");
...
//     out.println("<input type=\"hidden\" name=\"subs\" value=\""+s2+"\">");
     ...
     try  {
                 ...
                 out.println("</strong>");
                 out.println("<br>");
                 rs = stmt.executeQuery("SELECT * FROM "+s2+s1+" where queno >= "+ccm+" and queno <= "+ccm+"+4 and quefield='sho' and chap="+lno+" order by queno , wrong1");
                 int nRows = 0;
                ...
                out.println("<th><font face=\"Times New Roman\" size=\"4\">Answer</font></th>");
     ...
     out.println("<center>");
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Deleteshoq\">");
