...
public class Rev4s extends HttpServlet
{
...
//             String envf[] =gEnv.getAvailableFontFamilyNames();
       ...
       out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Rev4c\" target=\"topright\">");

     out.println("<strong><center><font face=\"Times New Roman\">Que-4</font></center></strong> ");
     out.println("</center><strong>");      // Join The Matches.
