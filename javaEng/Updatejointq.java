...
public class Updatejointq extends HttpServlet
{
...
*/      
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Updatejointq1\">");
...
//     out.println("<input type=\"hidden\" name=\"subs\" value=\""+s2+"\">");
           ...
           //     out.println("<th>TrueAns</th>");
                ...
                out.println("</tr>");
                 ...
                 while(rs.next()) {
                                    ...
                                    out.println("<td>");
                                    out.println("<input type=\"text\" name=\""+qno+ww1+"qt\" value=\""+qt+"\" style=\"font-family:"+fname+";font-size:14pt\">");
                                    out.println("</td>");
     ...
     out.println("<center>");
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Updatejointq\">");
