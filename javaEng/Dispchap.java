...
public class Dispchap extends HttpServlet
{
 public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
             
    {
      ...
      out.println("<center>");
      out.println("<font face=\"Times New Roman\" size=\"5\"><strong>Question Report Of Particular Chapter.</strong></font>");
      out.println("</center>");
    ...
    //********************** <option value=\"computer\">computer</option>
      ...
      out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("<input  type=\"submit\" value=\"Submit Standard\" name=\"submit\" style=\"font-family: Times New Roman; font-size: 14pt\"></center> ");
