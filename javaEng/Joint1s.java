...
public class Joint1s extends HttpServlet
{
...
////**********************Inserting into subject table**********
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Joint1c\" target=\"topright\">");

     out.println("<center><strong><center><font face=\"Times New Roman\" size=\"4\">Que-4</font></center></strong></center>");
