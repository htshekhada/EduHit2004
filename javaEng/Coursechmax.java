...
public class Coursechmax extends HttpServlet
{
 ...
 //     int m1,m2,m3,m4;
      ...
      out.println("<tr><th><strong><font face=\"Times New Roman\" size=\"4\">Standard-</font></strong><strong>"+s1+"</strong></th><th><strong><font face=\"Times New Roman\" size=\"4\">Class-</font></strong><strong>"+c1+"</strong></th><th><strong><font face=\"Times New Roman\" size=\"4\">Subject-</font></strong><strong>"+s2+"</strong></th></tr>");
     ...
     out.println("<tr>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Chap No</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Total Q-1</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Q-1</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Total Q-2</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Q-2</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Total Q-3</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Q-3</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Total Q-4</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Q-4</font></th>");
     out.println("<th><font face=\"Times New Roman\" size=\"4\">Total Marks</font></th>");
     ...
     try  {
                 ...
                 while(rs.next() ) {
                  ...
                  out.println("<th>");
                  out.println("<font face=\"Times New Roman\" size=\"4\">Total</font>");
                  out.println("</th>");
      ...
      //****FOR variable Long que************
                     ...
                     out.println("<font face=\"Times New Roman\" size=\"4\"><strong>Syllabus(Course) Of Que-5 (Select True Answer(s)).</strong>");
                     ...
                     out.println("<th><font face=\"Times New Roman\" size=\"4\">Wrong Ans</font></th>");
                     out.println("<th><font face=\"Times New Roman\" size=\"4\">Total Q-5</font></th>");
                     out.println("<th><font face=\"Times New Roman\" size=\"4\">Q-5</font></th>");
                     out.println("</tr>");
     ...
     out.println("<center>");
     out.println("<input  type=\"submit\" value=\"After Setting Syllabus Click This\" name=\"submit\" style=\"font-family: Times New Roman; font-size: 18pt\">&nbsp;&nbsp; ");
