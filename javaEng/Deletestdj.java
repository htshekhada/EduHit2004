...
import java.util.*;
public class Deletestdj extends HttpServlet
{
...
*/      
      ...
      out.println("<body bgcolor=\"rgb(133,213,135)\">");
              ...
              out.println("<center><strong><font face=\"Times New Roman\" size=\"4\" color=red>Deletion Of Questions From Que-4.</font></strong></center>");
              out.println("<br>");



      out.println("<form method=\"get\" action=\"http://"+request.getServerName()+":8080/servlet/Deletesubj\" target=\"middleleft\">");
