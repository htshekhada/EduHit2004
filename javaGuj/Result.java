...
//*********50*******
   ...
   //   d2=new java.util.Date();
      ...
      out.println("<tr><th><strong><center><font face=\"Lmg-Arun Condensed\" size=\"6\" color=\"blue\">:S], VYJF SM,[HG] GFD</font></center></font></strong></th></tr>");
      out.println("</table></center>");
      out.println("<center><table border=\"0\" width=\"500\">");
      out.println("<tr><th><strong><center><font face=\"Lmg-Arun Condensed\" size=\"5\" color=\"blue\">:S], VYJF SM,[HG] ;ZGFD] </font></center></font></strong></th></tr>");
      out.println("</table></center>");
      out.println("<center><table border=\"1\" width=\"500\">");
      out.println("<tr><th><strong><center><font face=\"Lmg-Arun Condensed\" size=\"5\" color=\"blue\">lJnFYL\"G] lJUTJFZ 5lZ6FD</font></center></font></strong></th></tr>");
      out.println("</table></center>");
      Connection con=null;
      Statement stmt=null;
    ...
    //  today = new java.util.Date();
     ...
     try  {
                ...
                rs = stmt.executeQuery("SELECT endtime FROM biodata AS t1 where rollno="+rollno+" and class='"+cl+"' and  std="+std+" and subject='"+sub+"'");
                 ...
                 out.println("<center><table border=\"1\" width=\"500\">");
                 out.println("<tr><td width=\"150\"><strong><font face=\"Lmg-Arun Condensed\" size=\"5\" >GFD o</font></strong></td>");
                 ...
                 rs.next();                           
                                            ...
                                            out.println("<tr><td width=\"150\"><strong><font face=\"Lmg-Arun Condensed\" size=\"5\" >ZM, G\\AZ</font></strong></td>");
                                            out.println("<td><strong>"+cc2+"</strong></td></tr>");
                                            out.println("<tr><td width=\"150\"><strong><font face=\"Lmg-Arun Condensed\" size=\"5\" >WMZ6vJU\"</font><strong></td>");
                                            out.println("<td><strong>"+cc3+"</strong></td></tr>");
                                            out.println("<tr><td width=\"150\"><strong><font face=\"Lmg-Arun Condensed\" size=\"5\" >lJQFI</font></strong></td>");
                                            out.println("<td><strong>"+sub+"</strong></td></tr>");
                                            out.println("<tr><td width=\"150\"><strong><font face=\"Lmg-Arun Condensed\" size=\"5\" >5ZL1FF VF%IF TFZLB</font></strong></td><td><strong>"+date1+"-"+month1+"-"+year1+"</strong></td></tr>");
                                            out.println("</table></center>");
                ...
                if(dupres==1)
                    {
                     ...
                     con.commit();
                                            ...
                                            out.println("<center><table border=\"1\" width=\"500\">");
                                            out.println("<tr><th></th><th><font face=\"Lmg-Arun Condensed\" size=\"4\">5|`Gv!</font>");
                                            out.println("</th><th><font face=\"Lmg-Arun Condensed\" size=\"4\">5|`GvZ</font>");
                                            out.println("</th><th><font face=\"Lmg-Arun Condensed\" size=\"4\">5|`Gv#</font>");
                                            out.println("</th><th><font face=\"Lmg-Arun Condensed\" size=\"4\">5|`Gv$</font>");
                                            out.println("</th><th><font face=\"Lmg-Arun Condensed\" size=\"4\">5|`Gv5</font></th>");
                                            out.println("<th><font face=\"Lmg-Arun Condensed\" size=\"4\">S],</font></th></tr>");
                                            out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\" size=\"4\" >S], U]6</font></strong></td>");
                                            ...
                                            out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\" size=\"4\" >D[/J[, U]6</font></strong></td>");
                                            ...
                                            out.println("</table></center>");
                                            out.println("<center><table border=\"1\" width=\"500\">");
                                            out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\" size=\"4\" >8SF</font></strong></td>");
                                            out.println("<th>" + taka + "%</th><th><font face=\"Lmg-Arun Condensed\" size=\"4\" >U|[0 </font></th><th>"+grade1+"</th></tr>");
                                            out.println("</table></center>");
                                            out.println("<center><table border=\"1\" width=\"500\">");
                                            if(stutime <= suptime)
                                            {
                                            out.println("<tr><th><strong>" + stutime + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face=\"Lmg-Arun Condensed\" size=\"4\" >DLGL8DF\\ 5ZL1FF 5]6\" SZL</font></strong></th>");
                                            out.println("</tr></table></center>");
                                            }
                                            else
                                            {
                                            out.println("<tr><th><strong><font face=\"Lmg-Arun Condensed\" size=\"4\" color=\"RED\" >lGIT ;DIDF\\ 5ZL1FF 5]6\" SZ[, GYL</font></strong></th>");
                                            out.println("</tr></table></center>");
                                            }
                                            out.println("<hr>");
                           if(mopt2>0)
                                     {
                                            ...
                                            out.println("<tr><th><center><font face=\"Lmg-Arun Condensed\" color=\"blue\" size=5 >5|`Gv! DF\\ 5]KFI[,F 5|`GM4 lJnFYL\"V[ VF5[, HJFA VG[ T[GF ;FRF HJFAM</font></center></th></tr>");
                                            out.println("</table></center>");
                                            ...
                                            while(rs.next())
                                               {
                                                ...
                                                if(an1.equals("V1"))
                                                             {
                                                              out.println("<td width=350><strong><i><b><font face=\"Lmg-Arun Condensed\">VF5[, HJFA </font><font face=\"Arial\">-&nbsp;&nbsp;</font><font face=\"Lmg-Arun Condensed\" color=\"green\"> ;FRM K[P</font></i></b></strong></td>");
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;</font></font><font face="+fon+" >"+r1+"</font></td></tr>");
                                                             }
                                                if(an1.equals("V2"))
                                                             {
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\">VF5[, HJFA </font></strong><font face=\"Arial\">-&nbsp;&nbsp;</font><font face="+fon+" >"+w1+"</font></td>");
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;</font><font face="+fon+" >"+r1+"</font></td></tr>");
                                                              }
                                                if(an1.equals("V3"))
                                                             {
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\">VF5[, HJFA </font></strong><font face=\"Arial\">-&nbsp;&nbsp;</font><font face="+fon+" >"+w2+"</font></td>");
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;</font><font face="+fon+" >"+r1+"</font></td></tr>");
                                                              }
                                                if(an1.equals("hitesh"))
                                                             {
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\"><i>:JLSFZ[, GYLP</i></font></strong></td>");
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;</font><font face="+fon+" >"+r1+"</font></td></tr>");
                                                             }
                                                if(an1.equals("V5"))
                                                             {
                                                              out.println("<td width=350><strong><i><b><font face=\"Lmg-Arun Condensed\">VF5[, HJFA </font><font face=\"Arial\">-&nbsp;&nbsp;</font><font face=\"Lmg-Arun Condensed\" color=\"green\">HJFA VF5[, GYL</font></i></b></strong></td>");
                                                              out.println("<td width=350><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;</font></font><font face="+fon+" >"+r1+"</font></td></tr>");
                                                             }
                                               out.println("</b>");
                                               out.println("</table></center>");
                                   ...
                                   if(msho2>0)
                                        {
                                            i=0;
                                            out.println("<center><table border=\"1\" width=\"700\">");
                                            out.println("<th><b><font face=\"Lmg-Arun Condensed\" color=\"blue\" size=5 >5|`GvZ DF\\ 5]KFI[,F 5|`GM4 lJnFYL\"V[ VF5[, HJFA VG[ T[GF ;FRF HJFAM</b></font>");
                                            out.println("</th></tr></table></center>");
                                            out.println("<b>");
                                            rs = stmt.executeQuery("SELECT *  FROM "+st+" where type='sho'");
                                            out.println("<center><table border=\"0\" width=\"700\">");
                                            out.println("<strong><tr><td><strong><b><font face=\"Lmg-Arun Condensed\" >G\\AZ</font></strong></b></td><td><strong><b><font face=\"Lmg-Arun Condensed\" >5|`G</font></strong></b></td><td><strong><b><font face=\"Lmg-Arun Condensed\" >VF5[, HJFA</font></strong></b></td><td><strong><b><font face=\"Lmg-Arun Condensed\" >;FRM HJFA</font></strong></b></td></tr></strong>");
                                          ...
                                          //                      }
                                            //    if(r1.equals(an1))
                                                if(r1.equalsIgnoreCase(an1))
                                                             {
                                                              out.println("<td><strong><i><b><font face=\"Lmg-Arun Condensed\" color=\"green\"> ;FRM K[P</font></i></b></strong></td>");
                                            ...
                                            while(rs.next())
                                               {
                                                ...
                                                fon=rs5.getString("fn");
                                                out.println("<center><table border=\"0\" width=\"700\">");
                                                out.println("<tr><td><font face=\"Arial\">("+i+")</font><pre><font face=\""+fon+"\">"+q1+"</font></pre></td></tr>");
                                                out.println("</table>");
                                                out.println("<center><table border=\"0\" width=\"700\">");
                                                if(an1.equals("V1"))
                                                             {
                                                              out.println("<tr><td><strong><i><b><font face=\"Lmg-Arun Condensed\">VF5[, HJFA</font><font face=\"Arial\">-&nbsp;&nbsp;</font><font face=\"Lmg-Arun Condensed\" color=\"green\">;FRM K[P</font></i></b></strong></td></tr>");
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;<pre></font></font><font face=\""+fon+"\" >"+r1+"</font></td></tr>");
                                                             }
                                                if(an1.equals("V2"))
                                                             {
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\">VF5[, HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;<pre></font><font face=\""+fon+"\" >"+w1+"</font></pre></td></tr>");
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;<pre></font><font face=\""+fon+"\" >"+r1+"</font></pre></td></tr>");
                                                              }
                                                if(an1.equals("V3"))
                                                             {
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\">VF5[, HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;<pre></font><font face=\""+fon+"\" >"+w2+"</font></pre></td></tr>");
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;<pre></font><font face=\""+fon+"\" >"+r1+"</font></pre></td></tr>");
                                                              }
                                                if(an1.equals("hitesh"))
                                                             {
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\"><i>:JLSFZ[, GYLP</i></font></strong></td></tr>");
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;<pre></font><font face=\""+fon+"\" >"+r1+"</font></pre></td></tr>");
                                                             }
                                                if(an1.equals("V5"))
                                                             {
                                                              out.println("<tr><td><strong><i><b><font face=\"Lmg-Arun Condensed\">VF5[, HJFA </font><font face=\"Arial\">-&nbsp;&nbsp;</font><font face=\"Lmg-Arun Condensed\" color=\"green\">HJFA VF5[, GYL</font></i></b></strong></td></tr>");
                                                              out.println("<tr><td><strong><font face=\"Lmg-Arun Condensed\">;FRM HJFA</font></strong><font face=\"Arial\">-&nbsp;&nbsp;<pre></font><font face=\""+fon+"\" >"+r1+"</font></pre></td></tr>");
                                                             }
                                               out.println("</b>");
                                               out.println("</table></center>");
                               ...
                               if(mjoi2 > 0)
                                          {
                                            ...
                                            k=1;
                                            out.println("<center><table border=\"1\" width=\"700\">");
                                            out.println("<tr><th><font face=\"Lmg-Arun Condensed\" color=\"blue\" size=\"5\">");
                                            out.println("<b>5|`Gv$ DF\\ 5]KFI[,F 5|`GM4 lJnFYL\"V[ VF5[, HJFA VG[ T[GF ;FRF HJFAM</b>");
                                            ...
                                            out.println("</table></center>");
                                            out.println("<center><table border=\"0\" width=\"700\">");
                                            out.println("<tr><td></td><td></td><td><strong><b><font face=\"Lmg-Arun Condensed\" >VF5[, HJFA</font></strong></b> </td><td><strong><b> <font face=\"Lmg-Arun Condensed\" >;FRM HJFA</font></strong></b></td><td></td></tr>");
                                            ...
                                            while(rs.next())                                    
                                               {
                                                ...
                                                if(an1.equals("hitesh"))
                                                 {
                                                out.println("<tr><td><font face=\"arial\">("+i+")</font></td><td><font face=\""+fon+"\" >"+q1+"</font></td><td><b><i><font face=\"Lmg-Arun Condensed\" color=\"green\">HJFA VF5[, GYL</font></i></b></td>");
                                                ...
                                                if(ff1.equals(an1))
                                                {
                                                out.println("<tr><td><font face=\"arial\">("+i+")</font></td><td><font face=\""+fon+"\" >"+q1+"</font></td><td><i><b><font face=\"Lmg-Arun Condensed\" color=\"green\"> ;FRM K[P</font></i></b></td>");
                                             ...
                                             // out.println("<td></td><td><font face=\""+fon+"\" >"+q1+"</font></td><td><font face=\""+fon+"\" >"+rr1+"</font></td></tr>");
                                               ...
                                               if(noatj==0)
                                               {
                                                 out.println("<font face=\"Lmg-Arun Condensed\" ><i><strong>TDFZM ;DI 5]6\" Y. UIM CMJFYL VF 5|`GGM TD[ HJFA VF5[, GYL</strong></i></font>");
                                               }
                    }
                  tvar=0;
                 ...
                 if(mvar2 > 0)
                  ...
                  out.println("<center><table border=\"1\" width=\"700\">");
                  out.println("<tr><th><font face=\"Lmg-Arun Condensed\" color=\"blue\" size=\"5\">");
                  out.println("<b>5|`Gv5 DF\\ 5]KFI[,F 5|`GM4 lJnFYL\"V[ VF5[, HJFA VG[ T[GF ;FRF HJFAM</b>");
                  out.println("</font></th></tr>");
                  out.println("</table></center><b>");
                  out.println("<center><table border=\"1\" width=\"700\">");
                  ...
                  while(rs.next() ) {
                                            ...
                                            out.println("<tr><td><strong><b><font face=\"Lmg-Arun Condensed\" >TD[ VF5[, ;FRF HJFAM </font></b></strong></td></tr>");
                                            varqno++;
                                            rn=rn*4-1;
                                            anl=av1.length();
                                            if(anl < rn)
                                        ...
                                        //t      out.println("<tr><td>no="+rano+"</td></tr>");
                                             ...
                                             out.println("<tr><td><strong><b><font face=\"Lmg-Arun Condensed\" >;FRF HJFAM</font></b></strong></td></tr>");
      ...
      out.println("<br><br>");
      out.println("<center><table border=\"0\" width=\"500\">");
      out.println("<tr><td><center><font face=\"Lmg-Arun Condensed\" size=\"5\" >JF,LGL ;CL</font></center></font></td><th width=\"200\"></th><td><font face=\"Lmg-Arun Condensed\" size=\"5\" >5ZL1FSGL ;CL</font></td></tr>");
      out.println("</table></center>");
