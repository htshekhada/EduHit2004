...
//      out.println(""+s1+","+c1+","+s2+"");
     out.println("<center><strong><font face=\"Lmg-Arun Condensed\" size=5>TD[ GSSL SZ[, VeIF;S|D GLR[ D]HA K[P</font></strong><br><br></center>");
 ...
 //*******display setting**********
                 ...
                 out.println("<table border=1>");
                                    ...
                                    out.println("<tr>");
                                    out.println("<th>");
                                    out.println("<font face=\"Lmg-Arun Condensed\" size=5>5F9 G\\AZ</font>");
                                    out.println("</th>");
                                    out.println("<th>");
                                    out.println("<font face=\"Lmg-Arun Condensed\" size=5>S], U]6</font>");
                                    out.println("</th>");
                                    out.println("</tr>");
                 ...
                 out.println("<center><br><br><b><font face=\"Lmg-Arun Condensed\" size=5>TD[ GSSL SZ[, VeIF;S|DGF S], U]6</font>:"+nrows+"</b></center>");
                 if(nrows==0)
                  {
                   ...
                   out.println("<br><center><strong>This Class Has Been Deleted.</strong></center>");
                                      ...
                                      out.println("<center><font face=\"Lmg-Arun Condensed\" size=5>:JLSFZ[, GYLP</font></center>");
                                      out.println("<pre>");
