...
public class Updateoptq extends HttpServlet
{
...
*/      
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Updateoptq1\">");
...
//     out.println("<input type=\"hidden\" name=\"subs\" value=\""+s2+"\">");
     ...
     out.println("<center>");
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Updateoptq\">");
