...
public class Shortques extends HttpServlet
{
...
////**********************Inserting into subject table**********
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Shortquec\" target=\"topright\">");
     ...
     out.println("<strong><font face=\"Lmg-Arun Condensed\" size=\"5\">lJQFI</font></strong>");
     out.println("<strong>");
