...
public class Rev5 extends HttpServlet
{
...
//             String envf[] =gEnv.getAvailableFontFamilyNames();
       ...
       out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Rev5s\" target=\"topmiddle\">");

     out.println("<strong><center><font face=\"Lmg-Arun Condensed\">5|`Gv5</font></center></strong> ");
