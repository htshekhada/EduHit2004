...
public class Fresult1 extends HttpServlet
{
 public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
             
    {
     ...
     out.println("<br><br><p><strong><center><font face=\"Lmg-Arun Condensed\" size=\"5\">SM. 56 lJnFYL\"GL VtIFZ ;]WLDF\\ ,[JFDF\\ VFJ[,L AWL H 5ZL1FFGF 5ZL6FD</font></center></strong> </p>");
     out.println("<br> ");
  ...
  */
      ...
      try  {
                 ...
                 out.println("<strong><br><center><font face=\"Lmg-Arun Condensed\" size=\"5\">WMZ6</font></strong>");
                 out.println("<strong>");
                 ...
                 out.println("<strong><font face=\"Lmg-Arun Condensed\" size=\"5\">ZM, G\\AZ</font></strong>");
                 out.println("<strong>");
                 ...
                 out.println("<strong><font face=\"Lmg-Arun Condensed\" size=\"5\">JU\"</font></strong>");
                 out.println("<strong>");
...
*/
     out.println("<center><input type=\"file\" name=\"image\" value=\"a\"></center>");
     out.println("<br>");
    // out.println("<br>");

     out.println("<center>");
     out.println("<br><center><input type=\"submit\" value=\"p5ZGL DFCLTL VF5L VF A8G NAFJM\" name=\"submit\" style=\"font-family: LMG-Arun Condensed; font-size: 18pt\" ></center>");
