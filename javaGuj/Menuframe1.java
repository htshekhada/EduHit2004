...
import java.util.*;
public class Menuframe1 extends HttpServlet
{
...
//      System.out.println(""+request.getRemoteHost()+"-SUPER USER ACCESS-"+d1+"");
      ...
      out.println("<frame name=\"bottom\" src=\"http://"+request.getServerName()+":8080/servlet/Entryfield\" >");
      ...
      out.println("<frame name=\"bottom1\" src=\"http://"+request.getServerName()+":8080/servlet/Suhelp1\">");
