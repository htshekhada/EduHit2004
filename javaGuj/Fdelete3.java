...
import java.util.*;
public class Fdelete3 extends HttpServlet
{
...
*/      
      ...
      out.println("<form method=\"get\" action=\"http://"+request.getServerName()+":8080/servlet/Fdelete4\" target=\"middle\">");
      ...
      ResultSet rs=null;
              ...
              out.println("<br>");
              out.println("<center><strong><font face=\"Lmg-Arun Condensed\" color=red size=5>SM. 56 WMZ6GM lJQFI VG[ T[GF AWF H 5|`GM E];JF DF8[GM lJEFU</font></strong></center>");
              out.println("<br>");
