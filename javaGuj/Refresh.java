...
*/
      ...
      out.println("<body bgcolor=\"rgb(133,213,135)\">");
              ...
              out.println("<br>");
              out.println("<center><strong><font face=\"Lmg-Arun Condensed\" color=\"red\"  size=\"5\">ZLO|[X</font></strong></center>");
              out.println("<br>");


         out.println("<center>");
         out.println("<form method=\"get\" action=http://"+request.getServerName()+":8080/servlet/Refresht target=\"bottom1\">");
         out.println("<input  type=\"submit\" value=\"     GSFDF     \" name=\"start\" style=\"font-family: LMG-Arun Condensed; font-size: 24pt\">");
 ...
 */      
         ...
         out.println("<input  type=\"submit\" value=\" V[S lJnFYL \" name=\"start\" style=\"font-family: LMG-Arun Condensed; font-size: 24pt\">");
         ...
         out.println("<input  type=\"submit\" value=\"lJQFI 5ZL6FD\" name=\"start\" style=\"font-family: LMG-Arun Condensed; font-size: 24pt\">");
