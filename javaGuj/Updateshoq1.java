...
public class Updateshoq1 extends HttpServlet
{
...
*/
     ...
     try  {
               ...
               //  rs = stmt.executeQuery("SELECT * FROM "+stdsub+" where queno >= "+ccm+" and queno <= "+ccm+"+1 and quefield='sho' order by queno , wrong1");
                rs = stmt.executeQuery("SELECT * FROM "+stdsub+" where queno >= "+ccm+" and queno <= "+ccm+"+4 and quefield='sho' and chap="+lno+" order by queno ");
