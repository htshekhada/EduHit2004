...
public class Deletelongq1 extends HttpServlet
{
                 ...
                 while(rs.next()) {
                                 ...
                                 while(eParmNames.hasMoreElements()) {
                                                 ...
                                                 if(name.equals(""+qno+"d"))
                                                        {
                                                          out.println(""+qno+",");
                                                          stmt1.executeUpdate("delete * from "+stdsub+"l where queno = "+qno+" and quefield='lon' and chap="+lno+";");
                                                          con1.commit();
