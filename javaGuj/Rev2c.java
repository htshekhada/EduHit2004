...
public class Rev2c extends HttpServlet
{
...
//             String envf[] =gEnv.getAvailableFontFamilyNames();
       ...
       out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Revsho1\" target=\"bottom\">");

     out.println("<strong><center><font face=\"Lmg-Arun Condensed\">5|`GvZ</font></center></strong> ");
     ...
     out.println("<select  name=\"lno\" size=\"1\">");
      ...
      try  {
                 ...
                 rs = stmt.executeQuery("SELECT DISTINCT chap AS c1 FROM "+sub+std1+" where quefield='sho';");
                 int nRows = 0;
                 while(rs.next() ) {
