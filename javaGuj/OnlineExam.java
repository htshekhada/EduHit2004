...
//       out.println("<tr><th><strong><marquee Behavior=\"alternate\" ><font face=\"Lmg-Arun Condensed\" size=5 color=\"rgb(255,0,0)\">E6TZ </font></marquee></strong></th></tr>");
       out.println("<tr><th><strong><marquee Behavior=\"alternate\" scrolldelay=\"250\"><input type=\"button\" name=\"eh\" value=\"V[HI]S[XGlC8 ;MO8J[Z\"  style=\"font-family: LMG-Arun Condensed; font-size: 24pt;  background-color: rgb(133,213,135); color: rgb(0,0,0); border-style: dotted\" ></marquee></strong></th></tr>");
       out.println("<tr><th><font face=\"Lmg-Arun Condensed\" size=3 color=\"rgb(255,0,0)\">:S], 4 SM,[H VG[ S,F;L; DF8[GM ;\\5]6\" pS[,</font></th></tr>");
       out.println("</table>");
       ...
       out.println("<font face=\"Lmg-Arun Condensed\" size=7 color=\"RGB(0,0,255)\">5ZL1FF</font>");     //  out.println("<img src=\"c:/onlinexam/img/m1.gif\" border=0 align=\"right\">");
   //    out.println("<input type=\"submit\" name=\"eh\" value=\"5ZL1FF\"  style=\"font-family: LMG-Arun Condensed; font-size: 24pt;  background-color: #008080; color: #000000 \">"); 
       ...
       out.println("<font face=\"Lmg-Arun Condensed\" size=7 color=\"RGB(0,0,255)\">5]GZFJT\"G</font>");   //    out.println("<img src=\"c:/onlinexam/img/m2.gif\" border=0 align=\"right\">");
   //    out.println("<input type=\"submit\" name=\"eh\" value=\"5]GZFJT\"G\"  style=\"font-family: LMG-Arun Condensed; font-size: 24pt;  background-color: #008080; color: #000000 \">");
       ...
       out.println("<font face=\"Lmg-Arun Condensed\" size=7 color=\"RGB(0,0,255)\">lGIFDS</font>");     //   out.println("<img src=\"c:/onlinexam/img/m3.gif\" border=0 align=\"right\">");
...
*/
    //   out.println("<br>");
       ...
       out.println("<font face=\"Lmg-Arun Condensed\" size=4 color=\"RGB(0,0,255)\">DFZF lJX[</font>");    //   out.println("<img src=\"c:/onlinexam/img/m4.gif\" border=0 >");
       out.println("</a></td>");
       ...
       out.println("<font face=\"Lmg-Arun Condensed\" size=4 color=\"RGB(0,0,255)\">DNN</font>");   // out.println("<img src=\"c:/onlinexam/img/m5.gif\" border=0 >");
       out.println("</a></td></tr>");
       out.println("</table>");
   //    out.println("<br><br>");
...
//       out.println("<center><b><font face=\"Lmg-Arun Condensed\" size=3 color=\"rgb(0,0,0)\">!(4S{,FX GUZ ;M;FI8L4  8L\\AFJF0L4  HF]GFU-4 OMGs3Zfv_Z(5vZ&*&&$$P</font></b></center>");
