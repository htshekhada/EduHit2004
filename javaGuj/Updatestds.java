...
import java.util.*;
public class Updatestds extends HttpServlet
{
...
*/      
      ...
      out.println("</a></td>");
         ...
         out.println("<th><strong><font face=\"Lmg-Arun Condensed\" size=\"4\">5|`GvZ  GF 5|`GMDF\\ ;]WFZM SZJFGM lJEFU</font></strong></th>");
...
//              out.println("<center><strong><font face=\"Lmg-Arun Condensed\" size=\"5\">5|`GvZ  GF 5|`GMDF\\ ;]WFZM SZJFGM lJEFU</font></strong></center>");
//              out.println("<br>");


      out.println("<form method=\"get\" action=\"http://"+request.getServerName()+":8080/servlet/Updatesubs\" target=\"middleleft\">");
