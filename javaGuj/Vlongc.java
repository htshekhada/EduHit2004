...
public class Vlongc extends HttpServlet
{
...
////**********************Inserting into subject table**********
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Vlong0\" target=\"middle\">");

     out.println("<center><strong><center><font face=\"Lmg-Arun Condensed\" size=\"5\">5|`Gv5</font></center></strong></center>");
     out.println("<center>");
