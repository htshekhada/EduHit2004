...
public class Shortquec extends HttpServlet
{
...
////**********************Inserting into subject table**********
     ...
     out.println("<form method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Shortque0\" target=\"middle\">");

     out.println("<center><strong><center><font face=\"Lmg-Arun Condensed\" size=\"5\">5|`GvZ</font></center></strong></center>");
     out.println("<center><strong>");

   
     out.println("<strong><font face=\"Lmg-Arun Condensed\" size=\"5\">5F9</font></strong>");
     out.println("<strong>");
     ...
     out.println("<select  name=\"lno\" size=\"1\" >");
       ...
       out.println("<strong><font face=\"Lmg-Arun Condensed\" size=\"5\">OMg8</FONT>");
     out.println("<select  name=\"F_name\" size=\"1\" ></strong>");
