...
import java.util.*;
public class Updatesubvc extends HttpServlet
{
...
*/      
      ...
      out.println("<form method=\"get\" action=\"http://"+request.getServerName()+":8080/servlet/Updatevarq\" target=\"bottom\">");
     ...
     try  {
                 ...
                 rs = stmt.executeQuery("SELECT distinct chap AS c1 FROM "+sub+std+"v ;");
                 int nRows = 0;
                 while(rs.next() ) {
