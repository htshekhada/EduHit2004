...
public class Bio extends HttpServlet
{
 public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
             
    {
      ...
      out.println("<br><br><center><b><font face=\"Times New Roman\" size=4 color=\"RGB(255,0,0)\">Select Member ID For Information.</font></b></center>");
      ...
      out.println("<form name=\"isn\" method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/Bioentry\">");
