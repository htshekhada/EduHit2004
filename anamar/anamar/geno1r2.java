...
public class geno1r2 extends HttpServlet
{
 public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
             
    {
      ...
      out.println("<br><center><strong><font face=\"Times New Roman\" size=\"5\" color=\"RED\">Geneology For Round-[2]</font></strong></center>");
   ...
   //   out.println("<form name=\"isn\" method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/geno1\">");
    ...
    int num1=0;          
    rs = stmt.executeQuery("SELECT *  FROM round2 where memberid='"+memid+"';");
    if(rs.next())
       num1=rs.getInt("num");
    ...
    int lvlno=0;
      ...
      rs = stmt.executeQuery("SELECT *  FROM round2 where num > "+num1+";");
      while(rs.next() ) {
                          ...
                          if(tot == 39)
                              {
                               out.println("<tr><th>Success</th><th></th><th></th><th></th><th></th></tr>");
                               lvlno=0;
                              }
