...
public class genor2 extends HttpServlet
{
 public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
             
    {
      ...
      out.println("<form name=\"isn\" method=\"GET\" action=\"http://"+request.getServerName()+":8080/servlet/geno1r2\">");

      

  out.println("<center><select  name=\"memberid\" size=\"1\" style=\"font-family:Times New Roman;font-size:\" >");
                
      rs = stmt.executeQuery("SELECT memberid AS c1 FROM round2 ;");
      while(rs.next() ) {
